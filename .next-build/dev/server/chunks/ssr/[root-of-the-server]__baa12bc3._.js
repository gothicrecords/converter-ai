...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setError('');
        setLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["login"])(formData.email, formData.password);
        if (result.success) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$analytics$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["trackLogin"])('email');
            router.push('/dashboard');
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__baa12bc3._.js.map