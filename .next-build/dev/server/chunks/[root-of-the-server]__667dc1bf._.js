    ...
    if (mimeType === 'application/pdf' || ext === '.pdf') {
        ...
        try {
            ...
            if (!text || text.length === 0) {
                console.error('[PDF Extract] Nessun testo trovato nel PDF');
            ...
            console.error('[PDF Extract] Errore estrazione PDF:', error.message, error.stack);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__667dc1bf._.js.map