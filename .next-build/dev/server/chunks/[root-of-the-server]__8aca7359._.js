    ...
    return (handler)=>{
        return async (req, res)=>{
            if (!methods.includes(req.method)) {
                ...
                return res.status(__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$index$2e$js__$5b$api$5d$__$28$ecmascript$29$__["HTTP_STATUS"].METHOD_NOT_ALLOWED).json({
...
[__TURBOPACK__imported__module__$5b$project$5d2f$middleware$2f$api$2e$js__$5b$api$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
 ...
 */ async function googleOAuthHandler(req, res) {
    ...
    if (!clientId) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$helpers$2f$response$2e$js__$5b$api$5d$__$28$ecmascript$29$__["sendError"])(res, 'Google OAuth not configured', __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$index$2e$js__$5b$api$5d$__$28$ecmascript$29$__["HTTP_STATUS"].SERVER_ERROR);
    }
    // Generate state token for CSRF protection
    const state = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)").randomBytes(32).toString('hex');
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$middleware$2f$api$2e$js__$5b$api$5d$__$28$ecmascript$29$__["apiHandler"])(googleOAuthHandler);
__turbopack_async_result__();
} catch(e) { __turbopack_async_result__(e); } }, false);}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8aca7359._.js.map